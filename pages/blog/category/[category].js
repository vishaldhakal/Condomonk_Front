      ...
      <div className="bg-white">
        <div className="py-5 mb-4 bg-light backk rounded-3 position-relative">
          ...
          <div className="container py-4 py-sm-5  col text-white cob2 position-relative">
            <h2 className="fw-bold cob position-relative fssss">
              Homebaba Blogs
            </h2>
...
export async function getStaticPaths() {
  ...
  const res = await fetch("https://api.condomonk.ca/api/categories/");
...
export async function getStaticProps({ params }) {
  const req = await fetch(
    "https://api.condomonk.ca/api/cat-post/" + params.category
  );
