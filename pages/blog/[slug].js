  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content={"https://api.condomonk.ca" + data.thumbnail_image}
        />
        <meta
          property="og:url"
                ...
                <div className="mt-5">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="text-secondary text-start py-2 d-flex align-items-center">
                      <img
                        src={
                          "https://api.condomonk.ca" + data.author.profile_img
                        }
                        alt="..."
...
export async function getStaticPaths() {
  ...
  const res = await fetch("https://api.condomonk.ca/api/posts/");
...
export async function getStaticProps({ params }) {
  const req = await fetch("https://api.condomonk.ca/api/posts/" + params.slug);
